# Laravel Web Installer | A Web Installer [Package](https://packagist.org/packages/abd-abdullah/web-installer)

[![Total Downloads](https://poser.pugx.org/rachidlaasri/laravel-installer/d/total.svg)](https://packagist.org/packages/abd-abdullah/web-installer)
[![Latest Stable Version](https://poser.pugx.org/rachidlaasri/laravel-installer/v/stable.svg)](https://packagist.org/packages/abd-abdullah/web-installer)
[![License](https://poser.pugx.org/rachidlaasri/laravel-installer/license.svg)](https://packagist.org/packages/abd-abdullah/web-installer)
...
```bash
    composer require abd-abdullah/web-installer
```
