...
Route::group(['prefix' => 'install', 'as' => 'WebInstaller::', 'namespace' => 'Abdullah\WebInstaller\Controllers', 'middleware' => ['web', 'install']], function () {
    Route::get('/', [
        'as' => 'welcome',
...
Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Abdullah\WebInstaller\Controllers', 'middleware' => 'web'], function () {
